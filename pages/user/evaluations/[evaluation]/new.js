...
function Home() {
    return (<>
        <div>
            <h1 style={{ marginTop: 9 }}>Please pick a evaluations above.</h1>
            <pre>
...
function Form() {
    ...
    if (!form) {
        ...
        return (
            <div>
                <a href={`/user/evaluations`}>&larr; Back to evaluation</a>
        ...
        <section>
            <div>
                <header style={{ padding: '10px 15px' }}>
                    <nav>
                        <h3><u>Integrated External Proficiency Testing</u></h3>
                        <Link href="/">Home</Link>
                    </nav>
                    <nav>
                        <ul>
